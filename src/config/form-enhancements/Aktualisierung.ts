// Auto-generated. Per-entity form-enhancements config for "Aktualisierung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['titel', 'prioritaet', 'status', 'datum', 'version', 'verantwortliche_person', 'betroffene_bereiche', 'beschreibung', 'anmerkungen'],
  defaults: {
    'datum': { kind: 'today' },
